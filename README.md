...
This repository is built around two placeholders to enable quick customization: `epsilon` and `epsilon-mobile-app`.
...
A very open Content-Security-Policy meta tag has been included in [two](content-shell/src/main/content/jcr_root/apps/epsilon/epsilon-mobile-app/components/ng-ionic-page/css_clientlibs.jsp) [places](content-shell/src/main/content/jcr_root/apps/epsilon/epsilon-mobile-app/components/splash-page/headlibs.jsp). You should review [the documentation](https://github.com/apache/cordova-plugin-whitelist#content-security-policy) on its usage and adjust this tag for your particular app's requirements.
